...
st.title("Your Urban Object Detection AI")

# Allow users to upload images or videos
uploaded_file = st.file_uploader("Upload an image or video you want to detect", type=["jpg", "jpeg", "png", "bmp", "mp4", "avi", "mov", "mkv"])
...
def process_media(input_path, output_path):
    ...
    if file_extension in ['.mp4', '.avi', '.mov', '.mkv']:
        # Ensure you have the predict_and_plot_video function defined
        return predict_and_plot_video(input_path, output_path)
    elif file_extension in ['.jpg', '.jpeg', '.png', '.bmp']:
        # Ensure you have the predict_and_save_image function defined
...
if 'uploaded_file' in locals() and uploaded_file is not None:
    ...
    try:
        # Save the uploaded file to the specified input path
        ...
        # Display the output if processing is successful
        if result_path:
